...
{
    /// <summary>
    /// Wrapper for the native implementation of "libdeepspeech"
    /// </summary>
    internal static class NativeImp
    {
        #region Native Implementation
        [DllImport("libdeepspeech", CallingConvention = CallingConvention.Cdecl,
        ...
        [DllImport("libdeepspeech", CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
